...
public class EchoArrowEntityRenderer extends ProjectileEntityRenderer<PersistentProjectileEntity> {
    ...
    public Identifier getTexture(PersistentProjectileEntity entity) {
        return FletchingExpanded.id("textures/entity/projectiles/echo_arrow.png");
    }
}
