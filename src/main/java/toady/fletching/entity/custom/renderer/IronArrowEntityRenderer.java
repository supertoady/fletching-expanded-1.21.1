...
public class IronArrowEntityRenderer extends ProjectileEntityRenderer<PersistentProjectileEntity> {
    ...
    public Identifier getTexture(PersistentProjectileEntity entity) {
        return FletchingExpanded.id("textures/entity/projectiles/iron_arrow.png");
    }
}
